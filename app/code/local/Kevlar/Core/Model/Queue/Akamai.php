 ...
 */
class Kevlar_Core_Model_Queue_Akamai extends Kevlar_Core_Model_Queue
{
    /**
     * Get queued up items
     *
    ...
    {
        return parent::getAll()->addFilter('type', 'akamai');
    }
    ...
    {
        return parent::getPending()->addFilter('type', 'akamai');
    }
    ...
    {
        return parent::getProcessed()->addFilter('type', 'akamai');
    }
}
